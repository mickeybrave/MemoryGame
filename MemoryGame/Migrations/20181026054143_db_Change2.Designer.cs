...
namespace MemoryGame.Migrations
{
    ...
    [Migration("20181026054143_db_Change2")]
    partial class db_Change2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemoryGame.Areas.Identity.Data.Config", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.Property<bool>("IsFromForeignLanguage");
            ...
            modelBuilder.Entity("MemoryGame.Areas.Identity.Data.User", b =>
                {
            ...
            modelBuilder.Entity("MemoryGame.Areas.Identity.Data.Config", b =>
                {
                    b.HasOne("MemoryGame.Areas.Identity.Data.User", "User")
                        .WithOne("Config")
                        .HasForeignKey("MemoryGame.Areas.Identity.Data.Config", "UserId");
                });
